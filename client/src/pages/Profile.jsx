        ...
        <div className='w-full h-screen flex items-center justify-center bg-gradient-to-br from-[#dde8f0] to-[#c5d8e8] p-12'>
            <div className='w-[460px] h-[500px] relative bg-white rounded-lg shadow-lg flex items-center justify-center flex-col gap-5'>
                <div className="rounded-t-lg rounded-b-[80%] p-18 bg-[#3f76ac] w-full h-1/4 absolute top-0 flex items-center justify-center">
                    <img src="https://img.freepik.com/premium-vector/blue-sign-with-persons-face-blue-circle-with-white-background_136558-83302.jpg" alt="" height={100} width={100} className='rounded-full ' />
                </div>
                <div className="flex flex-col justify-center items-center w-full gap-5 mt-24 p-10 ">
                    <form className='gap-4 flex flex-col justify-center w-full' onSubmit={(e) => handleSubmit(e)}>
                        <input type="text" onChange={(e) => setFormData({ ...formData, name: e.target.value })} value={formData.name} placeholder='John Doe' className='focus:none border-2 border-[#5e90ca] p-2 pl-3 shadow shadow-[#abc7dc99] outline-none rounded-full w-full' />
                        <textarea value={formData.bio} onChange={(e) => setFormData({ ...formData, bio: e.target.value })} placeholder='I am Currently now....' className='focus:none border-2 border-[#5e90ca] p-2 pl-3 shadow shadow-[#abc7dc99] outline-none rounded-3xl w-full resize-none' />
